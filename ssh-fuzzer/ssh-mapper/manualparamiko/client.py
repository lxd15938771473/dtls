...
from manualparamiko.agent import Agent
from manualparamiko.common import DEBUG
from manualparamiko.config import SSH_PORT
...
from manualparamiko.transport import Transport
from manualparamiko.util import ClosingContextManager
    ...
    def _auth(
        ...
        if pkey is not None:
            try:
                ...
                two_factor = (allowed_types == ['password']) #allowed_types & two_factor_types
                if not two_factor:
                    return
