...
from manualparamiko.common import zero_byte, max_byte, one_byte
...
class Message:
    ...
    def __bytes__(self):    #NOTE RENAMED FROM __str__
        return self.asbytes()
    ...
    def get_adaptive_int(self): #NOTE RENAMED FROM get_int
        """
    ...
    def get_int(self):  #NOTE RENAMED FROM get_size
        """
        Fetch an int from the stream.
        """
    ...
    def get_text(self):
        ...
        ``utf-8``.
        """
        return u(self.get_string()) #old u(self.get_bytes(self.get_size()))

    def get_binary(self):
        """
        Alias for `get_string` (obtains a bytestring).
        """
        return self.get_bytes(self.get_int()) #old self.get_bytes(self.get_size())
    ...
    def add_int(self, n): #NOTE RENAMED FROM add_size
        """
    ...
    def add_adaptive_int(self, n): #NOTE RENAMED FROM add_int
        """
        Add an integer to the stream.
